...
import static com.github.jinahya.persistence.sakila.Staff.ofStaffId;
...
import static com.github.jinahya.persistence.sakila.StoreConstants.PARAMETER_MANAGER_STAFF;
import static com.github.jinahya.persistence.sakila.StoreConstants.PARAMETER_MANAGER_STAFF_ID;
...
class Store_NamedQueries_IT
    ...
    class FindByManagerStaff {
            ...
            assertThatThrownBy(
                    () -> applyEntityManager(
                            em -> em.createNamedQuery(QUERY_FIND_BY_MANAGER_STAFF, Store.class)
                                    .setParameter(PARAMETER_MANAGER_STAFF, ofStaffId(0))
                                    .getSingleResult() // NoResultException
                    )
            ).isInstanceOf(NoResultException.class);
        }
        ...
        @Test
        void _NotNull_1() {
            final var managerStaff = ofStaffId(1);
            final var found = applyEntityManager(
                    em -> em.createNamedQuery(QUERY_FIND_BY_MANAGER_STAFF, Store.class)
