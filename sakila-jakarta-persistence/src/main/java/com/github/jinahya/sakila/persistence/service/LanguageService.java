...
import com.github.jinahya.sakila.persistence.Language;
import com.github.jinahya.sakila.persistence.LanguageConstants;
import com.github.jinahya.sakila.persistence.Language_;
    ...
    public Optional<@Valid Language> findByLanguageId(final @Positive int languageId) {
        ...
        return ofNullable(
                applyEntityManager(em -> {
                    try {
                        return em.createNamedQuery(LanguageConstants.QUERY_FIND_BY_LANGUAGE_ID, Language.class)
