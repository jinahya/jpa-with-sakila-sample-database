...
import static com.github.jinahya.sakila.persistence.__ActivatableHelper.getActiveField;
import static com.github.jinahya.sakila.persistence.__ActivatableHelper.getActiveVarHandle;
...
public interface __Activatable<ENTITY extends __BaseEntity<?> & __Activatable<ENTITY>> {
     ...
     * @see #getActive()
     * @see _DomainConverters.BooleanConverter#intToBoolean(int)
     */
    @Transient
     ...
     * @see _DomainConverters.BooleanConverter#booleanToInt(boolean)
