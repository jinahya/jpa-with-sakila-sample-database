...
import static com.github.jinahya.sakila.persistence.util.SecurityUtils.sha1;
import static com.github.jinahya.sakila.persistence.util.SecurityUtils.sha2;
...
@NamedQuery(
        name = StaffConstants.QUERY_FIND_ALL_BY_COUNTRY,
        query = """
                SELECT e
                FROM Staff AS e
...
@NamedQuery(
        name = StaffConstants.QUERY_FIND_ALL_BY_CITY,
        query = """
                SELECT e
                FROM Staff AS e
                        JOIN FETCH e.address AS a
...
@NamedQuery(
        name = StaffConstants.QUERY_FIND_ALL,
        query = """
                SELECT e
                FROM Staff AS e
...
@NamedQuery(
        name = StaffConstants.QUERY_FIND_BY_STAFF_ID,
        query = """
                SELECT e
                FROM Staff AS e
