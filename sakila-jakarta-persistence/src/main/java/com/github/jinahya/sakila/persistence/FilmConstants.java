...
public final class FilmConstants {
    ...
    static {
        ofNullable(Film_.languageId).map(Attribute::getName).ifPresent(v -> {
    ...
    static {
        ofNullable(Film_.language).map(Attribute::getName).ifPresent(v -> {
    ...
    static {
        ofNullable(Film_.originalLanguageId).map(Attribute::getName).ifPresent(v -> {
    ...
    static {
        ofNullable(Film_.originalLanguage).map(Attribute::getName).ifPresent(v -> {
