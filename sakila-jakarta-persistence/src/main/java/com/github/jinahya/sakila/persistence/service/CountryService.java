...
import com.github.jinahya.sakila.persistence.Country;
import com.github.jinahya.sakila.persistence.CountryConstants;
import com.github.jinahya.sakila.persistence.Country_;
                ...
                applyEntityManager(em -> {
                    try {
                        return em.createNamedQuery(CountryConstants.QUERY_FIND_BY_COUNTRY_ID, Country.class)
                                .setParameter(CountryConstants.PARAMETER_COUNTRY_ID, countryId)
