...
import com.github.jinahya.sakila.persistence.util.LocaleUtils;
 ...
 */
@NamedQuery(
        name = CountryConstants.QUERY_FIND_ALL,
        query = """
                SELECT e
                FROM Country AS e
...
@NamedQuery(
        name = CountryConstants.QUERY_FIND_BY_COUNTRY_ID,
        query = """
                SELECT e
                FROM Country AS e
...
@NamedNativeQuery(
        name = CountryConstants.NATIVE_QUERY_SELECT_ALL_KEYSET,
        query = """
                SELECT *
                FROM country
                WHERE country_id > ?
...
@NamedNativeQuery(
        name = CountryConstants.NATIVE_QUERY_SELECT_ALL_ROWSET,
        query = """
                SELECT *
                FROM country
                ORDER BY country_id ASC
...
@NamedNativeQuery(
        name = CountryConstants.NATIVE_QUERY_SELECT_BY_COUNTRY_ID,
        query = """
                SELECT *
                FROM country
                WHERE country_id = ?""",
