...
public final class ActorConstants {
    ...
    /**
     * The name of the query selects an entity identified by {@link Actor_#actorId actorId} attribute. The value is
     * {@value}.
     * <p>
     * The JPQL and an equivalent SQL are as follows.
     * <table>
     ...
     * @see Actor_#actorId
     */
    public static final String QUERY_FIND_ALL_BY_LAST_NAME_ACTOR_ID_GREATER_THAN
